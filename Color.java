...
/**
 * This class stores information about a particular color. 
 * 
 * @author Gayeon Park
 */
public class Color implements Comparable<Color> {
	...
	public Color (String colorHexValue) throws IllegalArgumentException{
		String validCharVals = "#abcdef";
		String validNums = "0123456789";

		//the parameter string length has to be 7 or otherwise error.
	...
	public Color (int red, int green, int blue) throws IllegalArgumentException{
		//if the int parameters for red, green and blue values
	 ...
	 * The comparison is done by the alphanumeric comparison of
	 * the hexadecimal value associated with the color.
	 ...
	 * The return string is formatted of three parts.
